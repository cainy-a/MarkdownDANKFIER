...
xdg-open ./bin/Debug/netcoreapp2.2/win-x64/publish

echo "Opening Windows32-bit build output directory"
xdg-open ./bin/Debug/netcoreapp2.2/win-x86/publish

echo "Opening Linux 64-bit build output directory"
xdg-open ./bin/Debug/netcoreapp2.2/linux-x64/publish

echo "Opening MacOS 64-bit build output directory"
xdg-open ./bin/Debug/netcoreapp2.2/osx-x64/publish